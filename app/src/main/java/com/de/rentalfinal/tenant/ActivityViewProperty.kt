...
class ActivityViewProperty : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        userRepository.getTypeById(currentUserId, onSuccess = {type ->

            if (type != "Tenant")
            {
                this.binding.btnAddToShortList.visibility = View.GONE
            }
            else {
                this.binding.btnAddToShortList.visibility = View.VISIBLE
            }
        })
    }
